        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex" href="{{ url('/') }}">
                    <div><img src="/svg/laravelTwitterCloneLogo.svg" alt="" class="pr-2" style="height: 22px;border-right: 1px solid #333"></div>
                    <div class="pl-2 pt-sm-1">Laravel Twitter Clone</div>
                </a>
